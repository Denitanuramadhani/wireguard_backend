...
-- ============================================
-- 
-- NOTE: This migration contains the base schema.
-- If you're setting up a new database, you can either:
-- 1. Run database/schema.sql directly (recommended for fresh install)
-- 2. Run this migration file (for migration system consistency)
--
-- This migration is idempotent - safe to run multiple times
-- ============================================

-- Create database (run this manually if needed)
-- CREATE DATABASE IF NOT EXISTS wireguard_vpn CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- USE wireguard_vpn;
...
-- ON DUPLICATE KEY UPDATE bandwidth_limit = 107374182400;
